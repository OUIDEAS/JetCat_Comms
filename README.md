...
- `throttle_cmd_1.py` and `read_port.py`: Timestamps with the processed data? Save to another file while also saving the PRO-Interface data to a file? There should be a time column in the `./decoded_data/XXXX-XX-XX/XXXX.csv` data files
...
- CFFI on Windows? Windows Subsystem for Linux
